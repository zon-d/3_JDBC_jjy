...
-- 내 정보 조회
SELECT MEMBER_NAME, MEMBER_ID, MEMBER_NM, MEMBER_GENDER, TO_CHAR(ENROLL_DATE, 'YYYY"년" MM"월" DD"일" HH24:MI:SS') ENROLL_DATE
FROM MEMBER
WHERE MEMBER_ID = '?'
...
INSERT INTO BOARD
VALUES(SEQ_BOARD_NO.NEXTVAL, '샘플 제목 1', '샘플 내용  입니다.', TO_DATE('2022-09-20 10:30:12', 'YYYY-MM-DD HH24:MI:SS'),
		DEFAULT, DEFAULT, 3);
	
INSERT INTO BOARD
VALUES(SEQ_BOARD_NO.NEXTVAL, '샘플 제목 2', '샘플 내용 2 입니다.', TO_DATE('2022-09-21 20:17:12', 'YYYY-MM-DD HH24:MI:SS'),
		DEFAULT, DEFAULT, 3);
	
INSERT INTO BOARD
VALUES(SEQ_BOARD_NO.NEXTVAL, '샘플 제목 4', '샘플 내용 4 입니다.', DEFAULT,
		DEFAULT, DEFAULT, 3);
...
CREATE TABLE "COMMENT"(
	...
	CONSTRAINT COMMNET_PK PRIMARY KEY(COMMENT_NO)
);
...
SELECT COMMENT_NO, COMMENT_CONTENT, MEMBER_NO, MEMBER_NM,
		TO_CHAR(CREATE_DT, 'YYY-MM-DD HH24:MI:SS') CREATE_DT
FROM "COMMENT"
JOIN "MEMBER" USING(MEMBER_NO)
WHERE DELETE_FL = 'N'
AND BOARD_NO = 3
...
-- 댓글 작성
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, ?, DEFAULT , DEFAULT, MEMBER_NO, BOARD_NO);
